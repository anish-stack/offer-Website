                        ...
                        <div className="col-span-4 overflow-hidden sm:col-span-9">
                            <div className="bg-white relative shadow rounded-lg p-6">
                                <div className='offer-tag'>
                                    <div className='tags-1'>{shopDetails ? shopDetails.HowMuchOfferPost || "0" : "N/A"} <span>/</span> 5 &nbsp;  <span>Post left</span> </div>
                                ...
                                <h3 className="font-semibold text-center mt-3 -mb-2">
                                    Make Your {shopDetails ? (shopDetails.HowMuchOfferPost === 0 ? "First" : "First") : "N/A"} Post
                                </h3>
